...
export default function LeadsError({ error, reset }: LeadsErrorProps) {
  ...
  return (
    <div className="rounded-3xl border border-rose-400/30 bg-rose-950/80 p-8 text-slate-100 shadow-2xl">
      ...
      <h1 className="mt-3 text-3xl font-semibold text-white">We couldn’t load leads</h1>
      <p className="mt-4 max-w-2xl text-base leading-7 text-slate-300">
        Please try again. If the issue continues, refresh the page and come back momentarily.
      </p>
      <button
        type="button"
        onClick={reset}
